...
"""
    ...
    if "Validation Test Scripts (UAT)" in artifacts_requested or "Validation Test Scripts (manual & automated cases)" in artifacts_requested:
        ...
        if _is_llm_error(test_content):
            generation_errors.append("Test_Scripts.docx")
        else:
...
async def update_artifacts_from_jira(request: Request):
    ...
    doc_specs = [
        ...
        ("Test_Scripts.docx", "Validation Test Scripts", "You are a QA Engineer. Generate a comprehensive validation Test Script in Markdown. Include columns for Test Case ID, Description, Steps, Expected Result, and Status."),
    ]
